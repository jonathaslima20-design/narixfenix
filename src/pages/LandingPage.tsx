...
function Pricing() {
  const plans = [
    ...
    },
    {
      ...
      price: 'R$ 49',
      period: '/mês',
      features: ['Chat integrado', 'Envios ilimitados', 'Suporte prioritário', 'Até 2 Instâncias'],
      cta: 'Assinar mensal',
      variant: 'ghost' as const,
    },
    {
      ...
      period: '/ano',
      badge: 'Economize 34%',
      features: ['Pagamento anual único', 'Envios ilimitados', 'Todas as funções Pro', 'Até 5 Instâncias'],
      cta: 'Assinar anual',
